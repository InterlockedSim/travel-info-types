...
/** Halteplaats waarvan alternatief vervoer aankomt of vertrekt. */
export type HalteplaatsPlannedActueel = InfoStatus & Halteplaats;

/**
 * De locatie van een specifiek punt van waar bijvoorbeeld alternatief vervoer
 * kan vertrekken.
 */
export type Halteplaats = {
    Lengtegraad: number;
    Breedtegraad: number;
    PresentatieHalteplaats?: MeertaligeUitingen;
};
...
/** Geeft aan tot wanneer het bericht geldig is. */
export type GeldigTot = string;
 ...
 * @constant de: German
 */
export type ISO6391LanguageCodeContent = 'nl' | 'en' | 'fr' | 'de';
...
/**
 * Volgorde van de materieeldelen zoals de trein het onderhavige station
 * verlaat. MaterieelDeelVolgordeVertrek bevat een volgnummer tellend vanaf de
 * kop van de trein beginnend met 1. In het geval een trein uit maar één
 * materieeldeel bestaat kan dit element worden weggelaten.
 */
export type MaterieelDeelVolgordeVertrek = number;
...
export type MaterieelDeelSoort = string;
...
/** Geeft de indicatie of deze rit relevant is voor de reisplanner. */
export type Reisplanner = indicatie;
...
/** Geeft de indicatie of het materieeldeel toegankelijk is. */
export type MaterieelDeelToegankelijk = indicatie;

/** Geeft de indicatie of het station toegankelijk is. */
export type StationToegankelijk = indicatie;

/** Geeft de indicatie of op station reisassistentie aanwezig is. */
export type StationReisAssistentie = indicatie;

/**
 * Geeft de indicatie of de hele trein afgerangeerd wordt. Alleen van toepassing
 * op het laatste station.
 */
export type TreinRangeertVolledigAf = indicatie;
 ...
 * alleen instappen, D = doorkomst, " " = In- en uitstappen, N = Niet voor
 * reizigers.
 */
export type StationnementType = 'U' | 'I' | 'D' | 'X' | 'N';
...
/**
 * Datum waarop de activiteit van de trein op het betreffende station wordt
 * uitgevoerd.
 */
export type TreinDatum = string;
...
/** Een unieke identificatie voor een trein op een bepaalde verkeers-/patroondag. */
export type LogischeRitNummer = string;
